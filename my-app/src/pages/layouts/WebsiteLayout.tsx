...
const WebsiteLayout = () => {
    return (
        <div>
            ...
            <div>
                <footer className="footer footer_1">
                    <div className="logo_content">
                        <div className="logo al_i_center">
                            <div className="font_menu text_uppercase text_weight_white un_select">
                    ...
                    <div>
                        ...
                        <ul>
                            ...
                            <li><a href="#">digital item unlock</a></li>
                        </ul>
                    </div>
                </footer>
